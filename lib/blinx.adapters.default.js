...
export class BlinxDefaultUI {
  /**
   * Optional renderer capability hook.
   * Custom renderers can override this to signal that they cannot render a specific field/cell.
   *
   * @returns {boolean} true when supported; false when unsupported
   */
  supportsField(_ctx = {}) {
    return true;
  }
